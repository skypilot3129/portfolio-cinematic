...
function Band({ maxSpeed = 50, minSpeed = 0 }: BandProps) {
  // Menggunakan "any" untuk ref karena tipe pastinya bergantung pada internal Rapier
        ...
        >
          ...
          >
            ...
            <mesh geometry={nodes.clip.geometry}>
              <meshPhysicalMaterial attach="material" {...materials.metal} roughness={0.3} />
            </mesh>
            <mesh geometry={nodes.clamp.geometry}>
              <meshPhysicalMaterial attach="material" {...materials.metal} />
            </mesh>
          </group>
        </RigidBody>
      </group>
